...
const NavBar = (props)=> {
    return (
      < >
       <nav className={`navbar fixed-top navbar-expand-lg navbar-${props.mode.theme==="dark"?"dark":"light"} bg-${props.mode.theme==="dark"?"dark":"light"}`}>
         <div className="container-fluid ">
            <Link className="navbar-brand" to="/" >EverydayNews</Link>
            ...
            <div className="form-check form-switch" style={{color:props.mode.color}}>
              <input className="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked" onChange={props.toggle}/>
